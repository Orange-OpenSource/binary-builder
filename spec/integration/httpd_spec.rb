...
describe 'building a binary', :integration do
  context 'when httpd is specified' do
    before(:all) do
      run_binary_builder('httpd', '2.4.29', '--md5=0c599404ef6b69eee95bcd9fcd094407')
    ...
    it 'builds the specified binary, tars it, and places it in your current working directory' do
      ...
      expect(output).to include('2.4.29')
    end
    ...
    it 'copies in *.so files for some of the compiled extensions' do
      ...
      expect(tar_contains_file('httpd/lib/libyajl.so.2')).to eq true
    end
  end
end
